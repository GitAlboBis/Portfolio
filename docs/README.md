...
| `C:/Users/alber/Desktop/PortfolioAlbertoTuveri/docs/04-3D-HERO-WATER-LOGO.md` | Logo AT/A a particelle d'acqua GPGPU a 2 strati, doppio backend WebGPU/WebGL2, fisica molla, shading acqua, Bloom/DOF, tuning, tier, pipeline Blender. | Implementare l'hero 3D e tutta la simulazione GPGPU. |
| `C:/Users/alber/Desktop/PortfolioAlbertoTuveri/docs/05-CINEMATIC-SCROLL.md` | Cinematica Pan di Zucchero + backflip Higgsfield, scroll-scrub, transizione-zoom, overlay WebGL, perf, fallback. | Implementare la sezione cinematica S3 e lo scrub video. |
...
| `C:/Users/alber/Desktop/PortfolioAlbertoTuveri/docs/07-PROJECTS.md` | Bio di Alberto + schede progetto (Badante24h, DOIT voice AI, academic supply chain) + voci Sersan provvisorie. | Scrivere il contenuto delle sezioni About e Work/Projects. |
